...
fluidRow(
    column(3,
      checkboxInput("addMImp", label = "show variable importance with background color",value=TRUE)),
    column(2,
...
fluidRow(
column(3,  
  checkboxInput("addImp", label = "show variable importance with background color",value=TRUE)),
column(3,
