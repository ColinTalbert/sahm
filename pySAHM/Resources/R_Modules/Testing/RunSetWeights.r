...
output.file="C:\\VisTrails\\mtalbert_20110504T132851\\readMaTests\\Spat.Weights.csv"
SetWeights(input.file,output.file,response.col="ResponseBinary",method="Density",sigma.sd=400)
